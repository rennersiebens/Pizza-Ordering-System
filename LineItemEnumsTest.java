...
class LineItemEnumsTest {
	...
	// For convenience:
		...
		public void setUp() throws Exception {
			pizza1 = new Pizza(sMedium, false, cSingle, tSingle, tSingle, tSingle);
		}
		...
		public void testCompareTo() throws Exception {
			LineItem same1 = new LineItem(1, new Pizza(sSmall, false, cSingle, tNone, tNone, tSingle)); // total cost $8.50
			LineItem same2 = new LineItem(1, new Pizza()); // total cost $8.50
			LineItem lower = new LineItem(2, new Pizza(sSmall, false, cDouble, tNone, tNone, tNone));
			LineItem higher1 = new LineItem(2, new Pizza(sSmall, false, cDouble, tNone, tNone, tSingle));
			LineItem higher2 = new LineItem(2, new Pizza(sMedium, false, cDouble, tNone, tNone, tSingle));
			LineItem highest = new LineItem(10, new Pizza(sSmall, false, cDouble, tNone, tNone, tSingle));
